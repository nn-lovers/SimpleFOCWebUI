    ...
    def toArduinoCode(self, generateParams=[]):
        ...
        if generateParams[1] or generateParams == []:
            ...
            code += (
                ...
                + str(self.PIDVelocity.outputRamp)
                + ";\n"
            )
            code += (
                "motor.PID_velocity.limit = "
                + str(self.PIDVelocity.outputLimit)
                + ";\n"
            )
        ...
        if generateParams[2] or generateParams == []:
            ...
            code += (
                "motor.P_angle.output_ramp = " + str(self.PIDAngle.outputRamp) + ";\n"
            )
        ...
        if generateParams[3] or generateParams == []:
            ...
            code += (
                ...
                + str(self.PIDCurrentQ.outputRamp)
                + ";\n"
            )
            code += (
                "motor.PID_current_q.limit = "
                + str(self.PIDCurrentQ.outputLimit)
                + ";\n"
            )
            code += "// Low pass filtering time constant \n"
        ...
        if generateParams[4] or generateParams == []:
            ...
            code += (
                ...
                + str(self.PIDCurrentD.outputRamp)
                + ";\n"
            )
            code += (
                "motor.PID_current_d.limit = "
                + str(self.PIDCurrentD.outputLimit)
                + ";\n"
            )
            code += "// Low pass filtering time constant \n"
        ...
        if generateParams[7] or generateParams == []:
            ...
            code += (
                "motor.sensor_electrical_offset = "
                + str(self.sensorElectricalZero)
                + ";\n"
            )
        ...
        if generateParams[9] or generateParams == []:
            ...
            code += ";\n"
            code += (
                "motor.modulation_centered = " + str(self.modulationCentered) + ";\n"
            )
