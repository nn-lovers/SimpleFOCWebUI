...
class ConfigureConnection(QtWidgets.QGroupBox):
    def __init__(self, parent=None):
        ...
        self.configCoonLayout.setObjectName("configureConnectionorizontalLayout")
    ...
    def getConfigValues(self):
        values = {
            ...
            "serialParity": list(serial.PARITY_NAMES.keys())[
                list(serial.PARITY_NAMES.values()).index(
    ...
    def connectionStateChanged(self, isConnectedFlag):
        if isConnectedFlag:
            ...
            self.connectDisconnectButton.setIcon(GUIToolKit.getIconByName("disconnect"))
        else:
            self.connectDisconnectButton.setText("Connect")
            self.connectDisconnectButton.setIcon(GUIToolKit.getIconByName("connect"))
